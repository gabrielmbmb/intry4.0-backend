# Generated by Django 2.2.13 on 2020-06-08 16:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_trained', models.DateField(blank=True, default=None, null=True)),
                ('date_deployed', models.DateField(blank=True, default=None, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('n_components', models.IntegerField(default=2, help_text='Numbers of components for the PCA algorithm')),
